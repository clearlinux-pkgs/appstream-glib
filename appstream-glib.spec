...
Source0  : https://people.freedesktop.org/~hughsient/appstream-glib/releases/appstream-glib-0.7.18.tar.xz
...
%prep
%setup -q -n appstream-glib-0.7.18
cd %{_builddir}/appstream-glib-0.7.18
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1601054029
...
cp %{_builddir}/appstream-glib-0.7.18/COPYING %{buildroot}/usr/share/package-licenses/appstream-glib/01a6b4bf79aca9b556822601186afab86e8c4fbf
cp %{_builddir}/appstream-glib-0.7.18/data/tests/rpmbuild-font/COPYING %{buildroot}/usr/share/package-licenses/appstream-glib/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
