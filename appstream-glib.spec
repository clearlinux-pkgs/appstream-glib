...
Source0  : https://people.freedesktop.org/~hughsient/appstream-glib/releases/appstream-glib-0.8.2.tar.xz
...
%prep
%setup -q -n appstream-glib-0.8.2
cd %{_builddir}/appstream-glib-0.8.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667586905
...
CFLAGS="$CFLAGS" CXXFLAGS="$CXXFLAGS" LDFLAGS="$LDFLAGS" meson --libdir=lib64 --prefix=/usr --buildtype=plain -Ddep11=false \
-Dstemmer=false \
-Drpm=false  builddir
ninja -v -C builddir
