...
Source0  : https://people.freedesktop.org/~hughsient/appstream-glib/releases/appstream-glib-0.8.1.tar.xz
...
%prep
%setup -q -n appstream-glib-0.8.1
cd %{_builddir}/appstream-glib-0.8.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661794714
